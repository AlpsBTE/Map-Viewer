import com.alpsbte.mapper.core.io.NBTInputStream;
import com.alpsbte.mapper.core.io.tags.Tag;
import com.alpsbte.mapper.core.world.regions.MCARegion;
...
public class MCARegionTest {

    private static MCARegion regionFile;
    ...
    @BeforeAll
    static void setUp() {
        regionFile = new MCARegion(new File(Objects.requireNonNull(MCARegion.class.getClassLoader().getResource("r.-1.-8.mca")).getFile()));
    }
